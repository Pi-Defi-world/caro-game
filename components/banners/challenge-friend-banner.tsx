...
export default function ChallengeFriendBanner() {
  ...
  return (
    <div className="relative h-full overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 px-3 py-4 shadow-2xl">
      <div
